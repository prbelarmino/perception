...
class GERALDDataset(Dataset):
    ...
    def __init__(self, path: str, transform=None, subset="all", shuffle=True,
        ...
        """
        print("Initializing GERALD Dataset")
        print("Using " + subset + " subset")
        print("Loading from: %s" % path)

        self.path = path

        with open(self.path + '/info.json','r', encoding='ISO-8859-1') as fp:
        ...
        print("Model input size: %s" % str(self.model_input_size))
        ...
        print("Total number of images: %5d" % len(self.filenames))
        print("Number of train images: %5d" % self.n_train_images)
        print("Number of validation images: %5d" % self.n_val_images)
        print("Number of test of images: %5d" % self.n_test_images)
        print("Use random data augmentation: " + str(self.random_augment))
        ...
        if self.subset == "train":
            ...
            print("Signals in the train subset:")
        elif self.subset == "val":
            self.subset_filenames = self.filenames[self.n_train_images:]
            self.subset_annotations = self.annotations[self.n_train_images:]
            print("Signals in the val subset:")
            ...
            print("Signals in the val (sunny) subset:")
            ...
            print("Signals in the val (cloudy) subset:")
            ...
            print("Signals in the val (rainy) subset:")
            ...
            print("Signals in the val (foggy) subset:")
            ...
            print("Signals in the val (snowy) subset:")
            ...
            print("Signals in the val (daylight) subset:")
            ...
            print("Signals in the val (twilight) subset:")
            ...
            print("Signals in the val (dark) subset:")
            ...
            print("Signals in the test subset:")
            ...
            print("Signals in the daylight subset:")
            ...
            print("Signals in the twilight subset:")
            ...
            print("Signals in the dark subset:")
            ...
            print("Signals in the sunny subset:")
            ...
            print("Signals in the cloudy subset:")
            ...
            print("Signals in the rainy subset:")
            ...
            print("Signals in the foggy subset:")
            ...
            print("Signals in the snowy subset:")
        ...
        print("Image area (Model input): %d px" % self.im_area)
    ...
    def import_xml_annotations(self, filenames):
        print("Importing XML annotations")
        annotations = []
